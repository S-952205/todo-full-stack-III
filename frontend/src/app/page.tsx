    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white">
      <div className="relative overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  ...
                  Sign up today to get started with your personal task dashboard.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="h-56 w-full bg-indigo-200 sm:h-72 md:h-96 lg:w-full lg:h-full opacity-50">
            {/* Placeholder for image or graphic */}
            <div className="flex items-center justify-center h-full">
              <div className="text-center p-8">
                <div className="inline-block bg-indigo-100 rounded-lg p-6">
                  ...
                  <p className="mt-4 text-indigo-800 font-medium">Task Management Dashboard</p>
                </div>
              </div>
            </div>
          </div>
